...
public class WaitTool {
    ...
    public static WebElement waitForElement(WebDriver driver, final By by) {
        ...
        try {
            ...
            driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(DEFAULT_WAIT_4_PAGE)); // reset implicitlyWait
    ...
    public static Boolean waitForInvisibilityOfElement(WebDriver driver, final By by, int timeOutInSeconds) {
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(0)); // nullify implicitlyWait()

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOutInSeconds));
        Boolean isVisible = wait.until(ExpectedConditions.invisibilityOfElementLocated(by));

        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(DEFAULT_WAIT_4_PAGE)); // reset implicitlyWait
        return isVisible; // return the element
    }
    ...
    public static boolean waitForTextPresent(WebDriver driver, final By by, final String text, int timeOutInSeconds) {
        ...
        try {
            driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(0)); // nullify
            // implicitlyWait()
            new WebDriverWait(driver, Duration.ofSeconds(timeOutInSeconds)).until(new ExpectedCondition<Boolean>() {
     ...
     * @param timeOutInSeconds The time in 4seconds to wait until returning a failure
     *
    ...
    /**
     * Waits for the document.readyState of the website to be equal to "complete"
     *
